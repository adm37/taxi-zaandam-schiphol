...
export default function WormerveerEindhovenAirport() {
  useEffect(() => {
    document.title = "Taxi Wormerveer Eindhoven Airport €295 - Vaste Prijs | ZaanTaxi Schiphol";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Taxi Wormerveer Eindhoven Airport nodig? Reis voor een vast tarief van €295. 24/7 service vanuit heel Wormerveer. Veilig, snel en comfortabel naar Eindhoven Airport.");
    
    const schemaData = {
      "@context": "https://schema.org",
      "@type": "TaxiService",
      "name": "ZaanTaxi Schiphol - Wormerveer naar Eindhoven Airport",
      "description": "De beste taxi service van Wormerveer naar Eindhoven Airport voor een vast tarief van €295.",
      "provider": {
        "@type": "LocalBusiness",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Taxi Wormerveer Eindhoven Airport",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
              "@type": "Service",
              "name": "Taxi Sedan Wormerveer naar Eindhoven Airport"
            },
            "price": "295.00",
            "priceCurrency": "EUR"
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Taxibus Wormerveer naar Eindhoven Airport"
            },
            "price": "365.00",
            "priceCurrency": "EUR"
          }
  ...
  return (
    <div className="pt-16">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-bold mb-6">
                <MapPin size={16} /> Taxi Wormerveer Eindhoven Airport Specialist
              </div>
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-stone-900 mb-6 leading-[1.1]">
                Betrouwbare Taxi van <span className="text-emerald-600">Wormerveer</span> naar Eindhoven Airport
              </h1>
              <p className="text-xl text-stone-600 mb-8 max-w-2xl">
                Reis zorgeloos en comfortabel van Wormerveer naar Eindhoven Airport voor het vaste lage tarief van <span className="font-bold text-emerald-600">€295</span>. Geen verborgen kosten, 24/7 beschikbaar.
              </p>
            ...
            <div className="hidden lg:block relative">
              <img 
                ...
                alt="Taxi Wormerveer Eindhoven Airport" 
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-stone-900">De Beste Taxi Service in Wormerveer naar Eindhoven Airport</h2>
                <div className="prose prose-stone text-stone-600 max-w-none space-y-6 leading-relaxed">
                  <p>
                    Bent u op zoek naar een <strong>taxi in Wormerveer</strong> die u veilig, snel en tegen een scherp tarief naar Eindhoven Airport brengt? ZaanTaxi Schiphol is uw lokale partner voor hoogwaardig luchthavenvervoer. Wij begrijpen dat uw reis begint bij de voordeur, en daarom zorgen wij voor een zorgeloze start.
                  </p>
                  <p>
                    Onze chauffeurs staan binnen 15 minuten bij u voor de deur in Wormerveer. Met onze jarenlange ervaring kennen wij elke weg en vermijden we de drukte waar mogelijk, zodat u altijd op tijd op Eindhoven Airport aankomt voor uw vlucht.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-stone-500 text-sm">Geen tikkende meter of verrassingen achteraf. U betaalt altijd €295 voor een sedan van Wormerveer naar Eindhoven Airport.</p>
                </div>
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
            ...
            <div className="space-y-8">
              <div className="bg-stone-900 text-white p-8 rounded-3xl sticky top-24">
                <h4 className="text-2xl font-bold mb-6">Tarieven Wormerveer - Eindhoven Airport</h4>
      ...
      <OtherAirportsLinks locationName="Wormerveer" locationSlug="wormerveer" currentAirportSlug="eindhoven-airport" />
    </div>
  );
}
