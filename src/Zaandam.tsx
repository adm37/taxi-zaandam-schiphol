...
export default function Zaandam() {
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Taxibus Zaandam naar Schiphol"
            },
            "price": "75.00",
            "priceCurrency": "EUR"
          }
  ...
  return (
    <div className="pt-16">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-bold mb-6">
                <MapPin size={16} /> Taxi Zaandam Schiphol Specialist
              </div>
              ...
              <div className="flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map(i => (
                    <img key={i} src={`https://picsum.photos/seed/${i+10}/40/40`} className="w-10 h-10 rounded-full border-2 border-white" alt="Klant" referrerPolicy="no-referrer" />
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-stone-900">De Beste Taxi Service in Zaandam naar Schiphol</h2>
                <div className="prose prose-stone text-stone-600 max-w-none space-y-6 leading-relaxed">
                  <p>
                    Bent u op zoek naar een <strong>taxi in Zaandam</strong> die u veilig, snel en tegen een scherp tarief naar Schiphol brengt? ZaanTaxi Schiphol is uw lokale partner voor hoogwaardig luchthavenvervoer. Wij begrijpen dat uw reis begint bij de voordeur, en daarom zorgen wij voor een zorgeloze start.
                  </p>
                  <p>
                    Of u nu in het bruisende centrum van Zaandam woont, in de rustige wijken van <strong>Westerwatering</strong>, <strong>Poelenburg</strong>, <strong>Peldersveld</strong> of <strong>'t Kalf</strong>, onze chauffeurs staan binnen 15 minuten bij u voor de deur. Met onze jarenlange ervaring in de Zaanstreek kennen wij elke weg en vermijden we de drukte waar mogelijk.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6 text-stone-900">Wijken in Zaandam waar wij rijden</h2>
                <p className="text-stone-600 mb-6">Wij bieden onze taxi service aan in alle delen van Zaandam, waaronder:</p>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    'Zaandam Centrum', 'Westerwatering', 'Poelenburg', 
                    'Peldersveld', 'Hoornseveld', 'Rosmolenwijk', 
                    "Oud West", "Nieuw West", "'t Kalf",
                    "Kogerveld", "Zaandam Zuid", "Havenbuurt"
                  ].map(wijk => (
            ...
            <div className="space-y-8">
              <div className="bg-stone-900 text-white p-8 rounded-3xl sticky top-24">
                <h4 className="text-2xl font-bold mb-6">Tarieven Zaandam</h4>
              ...
              <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <p className="text-emerald-700 text-xs mt-2 leading-relaxed">Gemiddeld duurt de rit van Zaandam naar Schiphol 20 tot 25 minuten, afhankelijk van het verkeer.</p>
                  </details>
                  <details className="group">
                    <summary className="font-bold text-sm text-emerald-800 cursor-pointer list-none flex justify-between items-center">
                      Waar staat de taxi op Schiphol?
                      <ChevronRight size={16} className="group-open:rotate-90 transition-transform" />
                    </summary>
                    <p className="text-emerald-700 text-xs mt-2 leading-relaxed">Wij spreken meestal af bij de STA-balie of bij de vertrekhal boven. U ontvangt altijd een bericht van de chauffeur.</p>
                  </details>
                </div>
              </div>
            </div>
      ...
      <OtherAirportsLinks locationName="Zaandam" locationSlug="zaandam" currentAirportSlug="" />
    </div>
  );
}
