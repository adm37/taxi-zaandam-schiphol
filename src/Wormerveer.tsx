...
export default function Wormerveer() {
  React.useEffect(() => {
    document.title = "Taxi Wormerveer Schiphol €75 | Betrouwbaar & Snel | ZaanTaxi Schiphol";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Taxi Wormerveer Schiphol nodig? Reis voor een vast tarief van €75. 24/7 service in heel Wormerveer. Veilig, snel en comfortabel luchthavenvervoer.");
    ...
    const schemaData = {
      ...
      "description": "De beste taxi service van Wormerveer naar Schiphol voor een vast tarief van €75.",
      "provider": {
        "@type": "LocalBusiness",
          ...
          >
            <div>
              ...
              <p className="text-xl text-stone-600 mb-8 max-w-2xl">
                Reis zorgeloos en comfortabel van Wormerveer naar Schiphol voor het vaste lage tarief van <span className="font-bold text-emerald-600">€75</span>. Geen verborgen kosten, 24/7 beschikbaar.
              </p>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <div className="prose prose-stone text-stone-600 max-w-none space-y-6 leading-relaxed">
                  ...
                  <p>
                    Wormerveer is een belangrijk knooppunt in de Zaanstreek. Wij bieden onze diensten aan in heel Wormerveer, van de Zaanweg tot aan de Noord. Voor een vast tarief van €75 bent u verzekerd van een comfortabele rit naar Schiphol. Onze chauffeurs kennen de regio door en door.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-stone-500 text-sm">Geen tikkende meter of verrassingen achteraf. U betaalt altijd €75 voor een sedan van Wormerveer naar Schiphol.</p>
                </div>
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: 'Linda K.', text: 'Vaste prijs van €75 is erg fijn. Geen verrassingen achteraf.' },
