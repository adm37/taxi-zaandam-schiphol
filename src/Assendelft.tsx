...
export default function Assendelft() {
  React.useEffect(() => {
    document.title = "Taxi Assendelft Schiphol €75 - Vaste Prijs | ZaanTaxi Schiphol";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Taxi Assendelft Schiphol nodig? Reis voor een vast tarief van €75. 24/7 service in heel Assendelft inclusief Saendelft en Kreekrijk. Veilig, snel en comfortabel.");
    ...
    const schemaData = {
      ...
      "description": "De beste taxi service van Assendelft naar Schiphol voor een vast tarief van €75.",
      "provider": {
        "@type": "LocalBusiness",
          ...
          >
            <div>
              ...
              <p className="text-xl text-stone-600 mb-8 max-w-2xl">
                Reis zorgeloos en comfortabel van Assendelft naar Schiphol voor het vaste lage tarief van <span className="font-bold text-emerald-600">€75</span>. Geen verborgen kosten, 24/7 beschikbaar.
              </p>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-stone-500 text-sm">Geen tikkende meter of verrassingen achteraf. U betaalt altijd €75 voor een sedan van Assendelft naar Schiphol.</p>
                </div>
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: 'Peter J.', text: 'Vaste prijs van €75 is top. Geen gezeur met de meter als er file staat op de A8.' },
