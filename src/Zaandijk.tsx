...
export default function Zaandijk() {
  React.useEffect(() => {
    document.title = "Taxi Zaandijk Schiphol €50 - Vaste Prijs | ZaanTaxi Schiphol";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Taxi Zaandijk Schiphol nodig? Reis voor een vast tarief van €50. 24/7 service in heel Zaandijk inclusief Rooswijk en Oud-Zaandijk. Veilig, snel en comfortabel.");
    
    // JSON-LD for Local Business / Taxi Service
    const schemaData = {
      "@context": "https://schema.org",
      "@type": "TaxiService",
      "name": "ZaanTaxi Schiphol - Zaandijk",
      "description": "De beste taxi service van Zaandijk naar Schiphol voor een vast tarief van €50.",
      "provider": {
        "@type": "LocalBusiness",
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Taxi Zaandijk Schiphol",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
              "@type": "Service",
              "name": "Taxi Sedan Zaandijk naar Schiphol"
            },
            "price": "50.00",
            "priceCurrency": "EUR"
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Taxibus Zaandijk naar Schiphol"
            },
            "price": "75.00",
            "priceCurrency": "EUR"
          }
    ...
    <div className="pt-16">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-bold mb-6">
                <MapPin size={16} /> Taxi Zaandijk Schiphol Specialist
              </div>
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-stone-900 mb-6 leading-[1.1]">
                Betrouwbare Taxi van <span className="text-emerald-600">Zaandijk</span> naar Schiphol
              </h1>
              <p className="text-xl text-stone-600 mb-8 max-w-2xl">
                Reis zorgeloos en comfortabel van Zaandijk naar Schiphol voor het vaste lage tarief van <span className="font-bold text-emerald-600">€50</span>. Geen verborgen kosten, 24/7 beschikbaar.
              </p>
              ...
              <div className="flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map(i => (
                    <img key={i} src={`https://picsum.photos/seed/${i+80}/40/40`} className="w-10 h-10 rounded-full border-2 border-white" alt="Klant" referrerPolicy="no-referrer" />
                  ))}
                </div>
                <div className="text-sm">
                  ...
                  <p className="text-stone-500 font-medium">4.9/5 door 220+ klanten in Zaandijk</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-stone-900">De Beste Taxi Service in Zaandijk naar Schiphol</h2>
                <div className="prose prose-stone text-stone-600 max-w-none space-y-6 leading-relaxed">
                  <p>
                    Bent u op zoek naar een <strong>taxi in Zaandijk</strong> die u veilig, snel en tegen een scherp tarief naar Schiphol brengt? ZaanTaxi Schiphol is uw lokale partner voor hoogwaardig luchthavenvervoer. Wij begrijpen dat uw reis begint bij de voordeur, en daarom zorgen wij voor een zorgeloze start.
                  </p>
                  <p>
                    Of u nu in de wijk <strong>Rooswijk</strong> woont of in het historische <strong>Oud-Zaandijk</strong>, onze chauffeurs staan binnen no-time bij u voor de deur. Voor een vast tarief van €50 brengen wij u comfortabel naar Schiphol. Wij zijn trots op onze lokale wortels in Zaandijk.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-stone-500 text-sm">Of u nu een vroege vlucht heeft om 04:00 's ochtends of laat in de nacht terugkomt, wij staan altijd voor u klaar in Zaandijk.</p>
                </div>
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                ...
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
                  ...
                  <p className="text-stone-500 text-sm">Geen tikkende meter of verrassingen achteraf. U betaalt altijd €50 voor een sedan van Zaandijk naar Schiphol.</p>
                </div>
                <div className="p-6 rounded-2xl bg-stone-50 border border-stone-100">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6 text-stone-900">Waarom ZaanTaxi Schiphol in Zaandijk?</h2>
                <ul className="list-none space-y-3">
                  <li className="flex items-start gap-3"><ThumbsUp size={20} className="text-emerald-500 mt-1" /><span><strong>Lokaal & Bekend:</strong> Wij zijn de specialist in Zaandijk.</span></li>
            ...
            <div className="space-y-8">
              <div className="bg-stone-900 text-white p-8 rounded-3xl sticky top-24">
                <h4 className="text-2xl font-bold mb-6">Tarieven Zaandijk</h4>
              ...
              <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <p className="text-emerald-700 text-xs mt-2 leading-relaxed">Gemiddeld duurt de rit van Zaandijk naar Schiphol 20 minuten.</p>
                  </details>
                  <details className="group">
                    <summary className="font-bold text-sm text-emerald-800 cursor-pointer list-none flex justify-between items-center">
                      Kan ik pinnen?
      ...
      <section className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12">Wat onze klanten in Zaandijk zeggen</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Bas R.', text: 'Goede service. De chauffeur was keurig op tijd in Rooswijk en hielp me met mijn koffers.' },
              { name: 'Sophie de L.', text: 'Vaste prijs van €50 is erg fijn. Geen verrassingen achteraf.' },
              { name: 'Gerrit van D.', text: 'Wij gebruiken ZaanTaxi Schiphol altijd voor onze vakanties vanuit Zaandijk.' }
            ].map((review, i) => (
      ...
      <OtherAirportsLinks locationName="Zaandijk" locationSlug="zaandijk" currentAirportSlug="" />
    </div>
  );
}
