...
export default function KoogAanDeZaan() {
  React.useEffect(() => {
    ...
    const schemaData = {
      ...
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Taxi Koog aan de Zaan Schiphol",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Taxibus Koog aan de Zaan naar Schiphol"
            },
            "price": "75.00",
            "priceCurrency": "EUR"
          }
    ...
    <div className="pt-16">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-sm font-bold mb-6">
                <MapPin size={16} /> Taxi Koog aan de Zaan Schiphol Specialist
              </div>
              ...
              <div className="flex items-center gap-6 justify-center lg:justify-start">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map(i => (
                    <img key={i} src={`https://picsum.photos/seed/${i+30}/40/40`} className="w-10 h-10 rounded-full border-2 border-white" alt="Klant" referrerPolicy="no-referrer" />
                  ))}
                </div>
                <div className="text-sm">
                  ...
                  <p className="text-stone-500 font-medium">4.9/5 door 350+ klanten in Koog aan de Zaan</p>
                </div>
              </div>
            </div>
            <div className="hidden lg:block relative">
              <img 
                ...
                alt="Taxi Koog aan de Zaan Schiphol" 
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-stone-900">De Beste Taxi Service in Koog aan de Zaan naar Schiphol</h2>
                <div className="prose prose-stone text-stone-600 max-w-none space-y-6 leading-relaxed">
                  <p>
                    Bent u op zoek naar een <strong>taxi in Koog aan de Zaan</strong> die u veilig, snel en tegen een scherp tarief naar Schiphol brengt? ZaanTaxi Schiphol is uw lokale partner voor hoogwaardig luchthavenvervoer. Wij begrijpen dat uw reis begint bij de voordeur, en daarom zorgen wij voor een zorgeloze start.
                  </p>
                  <p>
                    Of u nu in de wijk <strong>Westerkoog</strong> woont, dichtbij station <strong>Koog aan de Zaan</strong> of in het karakteristieke <strong>Oud-Koog</strong>, onze chauffeurs staan binnen no-time bij u voor de deur. Met onze jarenlange ervaring in de regio Zaanstad kennen wij elke weg en vermijden we de drukte waar mogelijk.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold mb-6 text-stone-900">Wijken in Koog aan de Zaan waar wij rijden</h2>
                <p className="text-stone-600 mb-6">Wij bieden onze taxi service aan in alle delen van Koog aan de Zaan, waaronder:</p>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    'Westerkoog', 'Oud-Koog', 'Station Koog aan de Zaan', 
                    'Molenwijk', 'Koog-Noord', 'Koog-Zuid'
                  ].map(wijk => (
            ...
            <div className="space-y-8">
              <div className="bg-stone-900 text-white p-8 rounded-3xl sticky top-24">
                <h4 className="text-2xl font-bold mb-6">Tarieven Koog aan de Zaan</h4>
              ...
              <div className="bg-emerald-50 p-8 rounded-3xl border border-emerald-100">
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <p className="text-emerald-700 text-xs mt-2 leading-relaxed">Gemiddeld duurt de rit van Koog aan de Zaan naar Schiphol 20 minuten.</p>
                  </details>
                  <details className="group">
                    <summary className="font-bold text-sm text-emerald-800 cursor-pointer list-none flex justify-between items-center">
                      Kan ik pinnen?
      ...
      <section className="py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12">Wat onze klanten in Koog aan de Zaan zeggen</h2>
      ...
      <OtherAirportsLinks locationName="Koog aan de Zaan" locationSlug="koog-aan-de-zaan" currentAirportSlug="" />
    </div>
  );
}
